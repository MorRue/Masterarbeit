...
def main(displaycase):
    if(displaycase == 1): disPlayVerticalPeriod("./Logs/Summary.csv") #displays the time-period of All Data
    if(displaycase == 2): displayVerticalTranslation("./Logs/Summary.csv") #displays the average vertical translation in the time period of All Data   
    if(displaycase == 3): displayMaximumTubethickness("./Logs/Summary.csv")  #displays the maximum tube thickness in the time-period
    if(displaycase == 4): displayVerticalTranslationAtBorder("./Logs/Summary.csv") #displays the average vertical translation at the border-cases
    if(displaycase == 5): verticalPeriodAtBorder("./Logs/Summary.csv") #displays the time-period at the border cases
    if(displaycase == 6): displayTubethicknessAtBorder("./Logs/Summary.csv") #displays the average tube thickness at the border cases
